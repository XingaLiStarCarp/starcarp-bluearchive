...
public class HumanSniper extends GeneralHumanoidMob {
	...
	public static final RegistryObject<EntityType<HumanSniper>> TYPE = HumanoidMob.newType(HumanSniper.class, HUMANOID_WIDTH, HUMANOID_HEIGHT, TYPE_NAME, SniperTrait.ATTRIBUTES);
